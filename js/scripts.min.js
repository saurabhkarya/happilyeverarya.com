...
// const btn = document.querySelectorAll(".event-box");

// btn.addEventListener("click", show_event);
...
// // Save full invitations and partial invitations as arrays
// const full_invite = ["Saurabh", "Shruti", "Mum", "Dad"];

// // Save inputs as variables
var name_input = document.querySelector("#nameinp");
var email_input = document.querySelector("#emailinp");
var continue_btn = document.querySelector(".cont-btn");

//   if (full_invite.includes(name_sub)) {
//     alert("hello");
//   } else {
//     alert("YOU AINT INVITED BOI");
//   }
// }

// Submit RSVP on click
continue_btn.addEventListener("click", submit_rsvp);
...
function submit_rsvp() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    fetch(form.action, {
      ...
      .then((html) => {
        // Did it it get posted?
        alert("success");

        // Retrieve input values
        name_sub = name_input.value;
        console.log(name_sub);
        email_sub = email_input.value;
        ...
        fetch("guestlist.json")
          .then((response) => response.json())
          .then((data) => {
            let obj = data.find((o) => o["First Name"] === name_sub);
            console.log(obj);
            if (typeof obj === "object") {
              if (
                ...
                console.log("NotHaldibutKidsM");
                location.href = "rsvp_3.html";
              } else if (
                obj["Sangeet"] === "Y" &&
                obj["Haldi"] === "N" &&
                obj["Adult Mehndi"] === "N" &&
                ...
                console.log("JustR");
                location.href = "rsvp_6.html";
              } else {
                console.log("WTF");
              }
            } else if (typeof obj === "undefined") {
              alert(
                "Please type your name again - didn't work - or contact Saurabh"
              );
            }
          });
      });
